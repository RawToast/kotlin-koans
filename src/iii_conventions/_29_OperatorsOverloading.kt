...
fun task29_1(today: MyDate): MyDate {
    return today.plus(RepeatedTimeInterval(YEAR, 1)).plus(RepeatedTimeInterval(WEEK,1))
}

fun task29_2(today: MyDate): MyDate {
    return today.plus(RepeatedTimeInterval(YEAR, 2)).plus(RepeatedTimeInterval(WEEK,3)).plus(RepeatedTimeInterval(DAY, 5))
}
